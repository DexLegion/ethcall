...
declare function initMulticallProvider(ethersProvider: EthersProvider, chainId?: number): Promise<IMulticallProvider>;
/**
...
declare class Provider {
     ...
     */
    init(provider: EthersProvider, chainId?: number): Promise<void>;
